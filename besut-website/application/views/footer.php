        ...
        <script type="text/javascript" src="<?=$baseurl?>assets/rs-plugin/js/jquery.themepunch.plugins.min.js"></script>
        <script type="text/javascript" src="<?=$baseurl?>assets/rs-plugin/js/jquery.themepunch.revolution.min.js"></script>
